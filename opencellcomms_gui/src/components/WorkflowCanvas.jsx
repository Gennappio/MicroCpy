      ...
      if (droppedData.type === 'parameterNode') {
        ...
        const newNode = {
          ...
          data: {
            ...
            forEach: droppedData.forEach || null,
            parameters: droppedData.parameters || {},
            enabled: true,
            description: droppedData.description || '',
            results: droppedData.results || '',
            contextMapping: droppedData.contextMapping || {},
            onEdit: () => {
    ...
    (parameters, customName, customMetadata) => {
      if (selectedNode) {
        ...
        if (selectedNode.type === 'parameterNode') {
          ...
          // For sub-workflow call nodes, update all properties
          setNodes((nds) =>
            nds.map((node) =>
              node.id === selectedNode.id
                ? {
                    ...
                    data: {
                      ...
                      forEach: customMetadata?.forEach !== undefined ? customMetadata.forEach : node.data.forEach,
