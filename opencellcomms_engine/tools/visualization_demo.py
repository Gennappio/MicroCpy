#!/usr/bin/env python3
"""
Visualization Demo for OpenCellComms Cell State Analysis Tools

This script demonstrates all visualization capabilities of the OpenCellComms analysis tools.
...
def main():
    print("[CELL] OpenCellComms Cell State Visualization Demo")
    print("=" * 80)
    ...
    if not Path(initial_state_file).exists():
        ...
        print("Please run OpenCellComms with save_initial_state: true first")
        return
