#!/usr/bin/env python3
"""
Cell State Analyzer Tool for OpenCellComms

This tool analyzes and displays the contents of cell state and initial state files
created by the OpenCellComms 3D Initial State System.
...
class CellStateAnalyzer:
    """Analyzer for OpenCellComms cell state files"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Analyze OpenCellComms cell state and initial state files",
