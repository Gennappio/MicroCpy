...
python run_workflow.py --generate --cells 1000 --radius 50

# Generate sparse cells concentrated at sphere border
python run_workflow.py --generate --cells 500 --radius 30 --sparseness 0.7 --radial 0.9
```
...
```bash
python run_workflow.py --generate --cells 1000 --radius 50 --radial 0.5
```
...
```bash
python run_workflow.py --generate --cells 1000 --radius 50 --radial 0.1
```
...
```bash
python run_workflow.py --generate --cells 1000 --radius 50 --radial 0.9
```
...
python run_workflow.py --generate --cells 1000 --sparseness 0.1

# Sparse population (sparseness = 0.8)
python run_workflow.py --generate --cells 1000 --sparseness 0.8
```
...
```bash
# Dense tumor core
python run_workflow.py --generate --cells 2000 --radius 30 --sparseness 0.1 --output dense_core

# Sparse periphery  
python run_workflow.py --generate --cells 500 --radius 50 --sparseness 0.8 --output sparse_periphery
```
...
```bash
python run_workflow.py --generate --cells 1000 --gene-probs hypoxic_genes.txt --output hypoxic_tumor
```

### Example 3: Size Scaling Study
```bash
# Small sphere
python run_workflow.py --generate --cells 200 --radius 20 --output small_sphere

# Medium sphere
python run_workflow.py --generate --cells 1000 --radius 40 --output medium_sphere

# Large sphere
python run_workflow.py --generate --cells 5000 --radius 80 --output large_sphere
```
...
python run_workflow.py --generate --cells 1000 --radius 50
python run_workflow.py --visualize generated_cells_TIMESTAMP.h5

# Or use convenience command
python run_workflow.py --generate --cells 1000 --radius 50
python run_workflow.py --all-viz generated_cells_TIMESTAMP.h5
```
...
python run_workflow.py --generate --cells 1000 --radius 50
python run_workflow.py --fipy generated_cells_TIMESTAMP.h5
```
...
python run_workflow.py --generate --cells 1000 --radius 50
python run_workflow.py --analyze generated_cells_TIMESTAMP.h5
```
...
python run_workflow.py --generate --cells 100 --radius 20
```

### 2. **Use Meaningful Names**
```bash
python run_workflow.py --generate --cells 1000 --output tumor_core_dense
```
...
python run_workflow.py --all-viz your_generated_file.h5
```
...
python run_workflow.py --generate --gene-probs my_genes.txt
```
...
- **Visualizer**: `python run_workflow.py --visualize file.h5`
- **Analyzer**: `python run_workflow.py --analyze file.h5`
- **FiPy Simulator**: `python run_workflow.py --fipy file.h5`
- **Inspector**: `python run_workflow.py --inspect file.h5`
