#!/usr/bin/env python3
"""
Cell State Visualizer for OpenCellComms
...
class CellStateVisualizer:
    """Visualizer for OpenCellComms cell state files"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Visualize OpenCellComms cell state and initial state files",
