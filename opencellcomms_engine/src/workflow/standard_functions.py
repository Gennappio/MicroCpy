...
def load_config_file(
    ...
    **kwargs
    ...
    try:
        ...
        # Resolve config file path relative to project root if not absolute
        config_path = Path(config_file)
        if not config_path.is_absolute():
            project_root = Path(__file__).parent.parent.parent  # src/workflow/standard_functions.py -> project root
