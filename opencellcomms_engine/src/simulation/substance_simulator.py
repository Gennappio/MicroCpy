"""
Substance simulation for OpenCellComms
    ...
    def _update_source_term(self, cell_reactions: Dict[Tuple[float, float], float]):
        ...
        for grid_pos, reaction_rate in cell_reactions.items():
            ...
            if cell_idx is not None:
                # Bypass all unit conversions and directly apply the standalone rate.
                # This ensures FiPy gets the EXACT same input as the standalone script,
