"""
Main plotting functionality for OpenCellComms
...
class SimulationPlotter:
    """
    Comprehensive plotting system for OpenCellComms simulations
    ...
    def plot_cell_population(self, population, title: str = "Cell Population", 
        ...
        if cell_colors_used:
            ...
            # Create border legend (phenotypes) - positioned at bottom right to avoid overlap
            if border_items:
                border_elements = [
