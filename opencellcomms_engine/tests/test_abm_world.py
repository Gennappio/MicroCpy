"""Unit tests for the ABM LatticeWorld (geometry, topology, occupancy)."""
...
def world(tx="bounded", ty="bounded"):
    return LatticeWorld(10, 10, 1, tx, ty)
