...
def read_readme():
    ...
    if os.path.exists(readme_path):
        with open(readme_path, 'r', encoding='utf-8') as f:
            return f.read()
    return "OpenCellComms: Multi-scale cellular simulation platform"
...
setup(
    ...
    entry_points={
        "console_scripts": [
            "opencellcomms-run=opencellcomms.cli:main",
            "opencellcomms-analyze=opencellcomms.analysis:main",
            "opencellcomms-plot=opencellcomms.visualization:main",
        ],
    },
