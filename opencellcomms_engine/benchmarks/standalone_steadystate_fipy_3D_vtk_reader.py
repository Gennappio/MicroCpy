...
This script reads cell state and position data from OpenCellComms H5 files, runs
...
class H5CellStateLoader:
    """Load cell state data from OpenCellComms H5 files"""
...
class FiPyVTKSimulator:
    ...
    def _export_vtk_simple(self, substance_name: str, values: np.ndarray, output_path: str):
        ...
        with open(output_path, 'w') as f:
            ...
            f.write(f"3D {substance_name} Concentration Field from OpenCellComms H5 Data\n")
            f.write("ASCII\n")
