#!/usr/bin/env python3
"""
OpenCellComms Master Runner
Run all OpenCellComms tools and simulations via command line flags
"""
...
Examples:
  ...
  python run_workflow.py --sim tests/jayatilake_experiment/jayatilake_experiment_config.yaml

  # Run workflow (complete user control)
  python run_workflow.py --workflow tests/jayatilake_experiment/jaya_workflow.json

  # Generate CSV cell files for 2D simulations
  python run_workflow.py --generate-csv --pattern spheroid --count 50 --output cells.csv
  python run_workflow.py --generate-csv --pattern grid --grid_size 5x5 --output grid_cells.csv

  # Generate CSV with complete gene network from BND file
  python run_workflow.py --generate-csv --pattern spheroid --count 25 --genes tests/jayatilake_experiment/jaya.bnd --output full_genes.csv
  ...
  python run_workflow.py --plot-csv --cells-dir results/csv_cells --substances-dir results/csv_substances --plot-output plots --snapshots --animation --statistics
        """
    )
