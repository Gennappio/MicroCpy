...
def test_gene_network_changes():
    ...
    try:
        ...
        for name, node in network.nodes.items():
            ...
            print("?  Minimal network doesn't have BooleanExpression nodes")

        # Test NetLogo-style update
        print("\n[TARGET] Testing NetLogo-style single gene update...")
    ...
    print("\n[SUCCESS] All tests passed! MicroC gene network now matches standalone version.")
    return True
